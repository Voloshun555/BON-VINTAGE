...
export const updateCatalogVisibleList = (state) =>
  state.options.selectedCategoryByFilter;
export const updateFilterMaterialsVisibleList = (state) =>
  state.options.selectedFilterByCategory;
export const selectBasketList = (state) => state.basket.basketList;
